      ...
      <div class="relative z-10">
        ...
        <header class="md:hidden sticky top-0">
          ...
          <Menubar :model="menuItems" class="container mx-auto">
            <template #end>
              <Button class="p-button-text p-button-rounded" @click="toggleDarkMode">
            ...
            <div class="max-w-4xl mx-auto">
              ...
              <section id="about" class="mb-12">
                <Card>
                  ...
                  <template #content>
                    <p class="pt-4">工業高校時代にインターネットにのめり込み、卒業後プログラマとしてキャリアを開始。 初めて業務で先輩から教えてもらった言語はC言語とJavaを経験。その後、外資系半導体企業で社内SEからSIerへ転職し主にJava, Perl, MFCを業務で使用。2018年中旬にメーカ系企業に転職し主にフロントエンド(PHP, Vue)を担当。 趣味は、バイクでのツーリング。</p>
                  </template>
                </Card>
              </section>
                  ...
                  <template #content>
                    <div class="pt-4">
                      <template v-for="skill in skills" :key="skill.title">
                        <SkillCard class="mb-4" :title="skill.title" :description="skill.description" :use-year="skill.useYear" />
                      </template>
                    </div>
                  </template>
                </Card>
